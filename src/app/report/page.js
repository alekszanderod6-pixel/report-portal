              ...
              <div className="space-y-4">
                <div>
                  <div className="flex items-center justify-between mb-1.5">
                    ...
                    <button onClick={() => enhance("important_work")} disabled={paraphrasing === "important_work" || !cur.important_work.trim()} className="btn btn-sm" style={{ background: "#F3F4F6", color: "var(--navy)", fontSize: "0.7rem" }}>
                      {paraphrasing === "important_work" ? <span className="spinner" style={{ width: 12, height: 12, borderWidth: 2 }} /> : <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09z" /></svg>}
                      Enhance
                    </button>
                  </div>
                ...
                <div>
                  <div className="flex items-center justify-between mb-1.5">
                    ...
                    <button onClick={() => enhance("completion_process")} disabled={paraphrasing === "completion_process" || !cur.completion_process.trim()} className="btn btn-sm" style={{ background: "#F3F4F6", color: "var(--navy)", fontSize: "0.7rem" }}>
                      {paraphrasing === "completion_process" ? <span className="spinner" style={{ width: 12, height: 12, borderWidth: 2 }} /> : <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09z" /></svg>}
                      Enhance
                    </button>
                  </div>
                ...
                <div className="flex items-center gap-2 pt-2">
                  ...
                  {editIdx !== null ? <button onClick={() => { setEditIdx(null); setCur({ important_work: "", completion_process: "", is_completed: "In Progress", spare_parts: "" }); }} className="btn btn-outline">Cancel Edit</button> : null}
                </div>
              </div>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl p-5" style={{ border: "1px solid var(--border)" }}>
              ...
              <div className="space-y-2 text-xs text-gray-500 leading-relaxed">
                ...
                <p>Include a Results: line at the end.</p>
